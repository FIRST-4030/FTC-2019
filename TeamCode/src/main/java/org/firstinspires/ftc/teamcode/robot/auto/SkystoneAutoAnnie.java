...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Skystone Side (Annie Test)", group = "Scissor")
public class SkystoneAutoAnnie extends OpMode {
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case ALIGN_WITH_SKYSTONE:
                    driver.drive = common.drive.distance(InchesToMM(12.0f + SkystoneOffset));
                advance();
                break;
